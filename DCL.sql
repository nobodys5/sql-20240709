...
-- GRANT: 특정 사용자에게 스키마메 대한 권한을 부여하는 명령어
-- GRANT 권한리스트 ON 데이터베이스.테이블 TO 유저이름@접근위치;

GRANT SELECT, INSERT ON practice_sql.example_table TO 'developer'@'127.0.0.1'; # 부분적으로 권한들고오는 코드

GRANT ALL ON *.* TO 'developer'@'127.0.0.1'; # 모든 권한을 들고올수있게 하는 코드
